---
title: "Relatório indicador 13 - PQA-VS Paraná"
output:
  html_document:
    toc: true
    toc_float: true
    theme: journal
# ---
# SAÍDA ALTERNATIVA PARA WORD (usando template)
# Para gerar o relatório em Word, comente a seção 'html_document' acima
# e descomente a seção 'word_document' abaixo.
# Certifique-se de que o arquivo 'modelo_rmarkdown.docx' está na mesma pasta.
# ---
#  word_document:
...
A seguir temos os resultados do indicador 13 para as regionais de saúde do Paraná no ano de 2022.

```{r echo=FALSE}
indicador13_gt
```

O gráfico a seguir apresenta o desempenho das macrorregionais de saúde do Paraná e o seu alcance em relação à meta do indicador 13 do PQA-VS.
...
O mapa abaixo apresenta o desempenho do indicador por município do Paraná para o indicador avaliado e se cada uma das cidades atingiu ou não a meta definida de acordo com os parâmetros definidos pelo Ministério da Saúde.
